...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('-t', '--min-time', type=float, default=1.0, help='min time in seconds for testing each query')
    parser.add_argument('-i', '--min-iterations', type=int, default=5, help='min iterations for testing each query')
    parser.add_argument('-e', '--epsilon', type=float, default=0.05, help='ignore difference below this threshold')
